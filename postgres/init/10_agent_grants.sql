...
GRANT UPDATE ON decision_architect.published_content TO familybrain_pr_agent_role;
GRANT UPDATE (last_published) ON decision_architect.theme TO familybrain_pr_agent_role;
